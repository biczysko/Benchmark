...
def run(file_name="helix_1us0_original.pdb"):
  #
  prefix="pdb/"
  #sub_path = "%s/refine_cctbx/"%prefix
  rmsd_dirs = ["0.3/","0.6/","0.9/","1.2/","1.5/"]
  file_names = ["0_refined.pdb","1_refined.pdb","2_refined.pdb","3_refined.pdb","4_refined.pdb","5_refined.pdb","6_refined.pdb","7_refined.pdb",
                "8_refined.pdb","9_refined.pdb"]
  # Identify i_seqs of O-H pairs involved into H bonds
  h_bonds_i_seqs = []
  h = iotbx.pdb.input(file_name="helix_1us0_original.pdb").construct_hierarchy()
  atoms = h.atoms()
  ...
  for sub_path in ["helix_1us0_gfn2-xtb_offcluster/",
                   "helix_1us0_gfnff-xtb6.3_offcluster/",
                   "helix_1us0_tc_offclust_OK/",
                   "helix_1us0_tc_hfd3gcp_offcluster_OK/",
                   "helix_1us0_gfn1-xtb_offcluster_OK/",
                   "helix_1us0_tc_hf3c_offcluster/",
                   "helix_1us0_ani-210405/"
                  ]:
    print sub_path
    for rmsd_dir in rmsd_dirs:
      ...
      for fn in file_names:
        file_name = sub_path+rmsd_dir+prefix+fn
